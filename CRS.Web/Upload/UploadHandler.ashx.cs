...
namespace MvcApplication1.Upload
{
    /// <summary>
    ...
    public class UploadHandler : IHttpHandler, IRequiresSessionState
    {
        ...
        {
            //string currentUser = SessionWrapper.CurrentUser.UserName + SessionWrapper.CurrentUser.ID.ToString(); 
            ...
            for (int i = 0; i < context.Request.Files.Count; i++)
            {
                ...
                var fileName = username + Path.GetFileName(file.FileName);
